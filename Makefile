...
ft_strlen.c ft_map.c ft_strmapi.c ft_strncat.c ft_strncmp.c ft_strncpy.c \
ft_strenqu.c ft_strnew.c ft_strnstr.c ft_strrchr.c ft_strsplit.c ft_strstr.c \
...
ft_strlen.o ft_map.o ft_strmapi.o ft_strncat.o ft_strncmp.o ft_strncpy.o \
ft_strenqu.o ft_strnew.o ft_strnstr.o ft_strrchr.o ft_strsplit.o ft_strstr.o \
ft_strsub.o ft_strtok.o ft_strtrim.o ft_tolower.o ft_toupper.o \
ft_wordcount.o ft_wordlength.o
