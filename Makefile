...
ft_toupper.c ft_wordcount.c ft_wordlength.c ft_memdel.c ft_putendl_fd.c \
ft_putnbr.c ft_putnbr_fd.c ft_strrchr.c
...
ft_toupper.o ft_wordcount.o ft_wordlength.o ft_memdel.o ft_putendl_fd.o \
ft_putnbr.o ft_putnbr_fd.o ft_strrchr.o
